class PopulateCountries <
  ActiveRecord::Migration
  def self.up
 Country.create(:name => 'Afghanistan')
Country.create(:name => 'Aland')
...
Country.create(:name => 'Ascension Island')
...
Country.create(:name => 'Cocos (Keeling) Island')
Country.create(:name => 'Colombia')
Country.create(:name => 'Comoros')
Country.create(:name => 'Congo, Republic of')
Country.create(:name => 'Congo, Democratic Republic of')
...
Country.create(:name => 'Heard and McDonald Islands')
...
Country.create(:name => 'Saudia Arabia')
...
Country.create(:name => 'United States Virgin Islands')
Country.create(:name => 'Uruguay')
Country.create(:name => 'US Minor Outlying Islands')
Country.create(:name => 'USSR')
